...
# import sentiment_model_cnn_v5 as sentiment_model_cnn
...
def main(args):
    ...
    #model = sentiment_model_lstm.keras_model_fn(None, training_config)
    ...
    # change the number of epochs so that it could have a shorter training time.
    model.fit(
        x=train_dataset[0], y=train_dataset[1], steps_per_epoch=train_dataset[2]["num_batches"],
        epochs=3,
        validation_data=(validation_dataset[0], validation_dataset[1]),
...
if __name__ == "__main__":
    os.environ["SM_CHANNEL_TRAIN"] =  '/Users/yongyizhao/Desktop/Archive_v2/SM_CHANNEL_TRAIN '
    os.environ["SM_CHANNEL_VALIDATION"] = '/Users/yongyizhao/Desktop/Archive_v2/SM_CHANNEL_TRAIN SM_CHANNEL_VALIDATION'
    os.environ["SM_CHANNEL_EVAL"] = '/Users/yongyizhao/Desktop/Archive_v2/SM_CHANNEL_TRAIN SM_CHANNEL_EVAL'
    os.environ["SM_MODEL_DIR"] = '/Users/yongyizhao/Desktop/Archive_v2/SM_CHANNEL_TRAIN SM_MODEL_DIR\cnn_v2'
